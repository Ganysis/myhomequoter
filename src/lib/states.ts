...
// Top cities per state (initial set - will be expanded via data import)
export const topCitiesByState: Record<string, string[]> = {
...
export function getTopCities(stateCode: string): string[] {
  return topCitiesByState[stateCode.toUpperCase()] || [];
}
